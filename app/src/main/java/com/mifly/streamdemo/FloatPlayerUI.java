...
//    private IServiceHelper mServiceHelper;
    ...
    public FloatPlayerUI(Context context) {
        super(context);
        mContext = context;
//        mServiceHelper = helper;
    ...
    private SurfaceHolder.Callback mCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            ...
            try {
                Log.i("lwt", Environment.getExternalStorageDirectory()
                        .getPath() + "/VideoDownLoadManage/ion.3gp");
...
//        VideoPlayerService.stopService(mContext);
    }
